        ...
        <div className="content-block" id="footer">
            <div style={{padding: "0px 10%"}}>
                <header className={`block-heading clearfix ${styles.h1Flex} text-center`} style={{marginBottom: "3%"}}>
                    <h1 style={{cursor: "default", color: "white"}}>Контакты</h1>
                </header>
                <div className="row">
                    <div className={`${styles.kSpecial} ${styles.adaptMap}`}>
                        <iframe
                    ...
                    <div className={`text-right ${styles.footText}`}>
                        ...
                        <a href="https://vk.com/artclub.bmstu" target="_blank">
                            <img src="/assets/images/vk.png" width="35" height="35"/>
                        </a>
                        <a href="https://www.instagram.com/artclubbmstu/" target="_blank">
                            <img src="/assets/images/inst.png" width="42" height="35"/>
                        </a>
                    </div>
                </div>
            </div>
